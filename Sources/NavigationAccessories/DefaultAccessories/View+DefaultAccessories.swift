...
public extension View {
    ...
    func navigationWeeTitle(_ title: String?) -> some View {
        navigationAccessory(title.map(WeeTitleAccessory.init))
    }
    ...
    ///   - content: A closure returning the view to display as the accessory. If `nil`, the accessory is not displayed and is removed from the hierarchy.
        ...
        navigationAccessory(
            content().map {
                LargeTitleAccessoryViewAccessory(
                    ...
                    content: HashableView(content: $0)
                )
            }
        )
    }
    ...
    ///   - content: A closure returning the view to display in the palette. If `nil`, the accessory is not displayed and is removed from the hierarchy.
    ...
    ///   - content: A closure returning the view to display as the custom title. If `nil`, the accessory is not displayed and is removed from the hierarchy.
